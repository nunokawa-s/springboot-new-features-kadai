...
public class ReviewController {
   ...
   {    
       ...
       reviewService.create(house, user, reviewPostForm);
   ...
   public String edit(@PathVariable(name = "houseId") Integer houseId, @PathVariable(name = "reviewId") Integer reviewId, Model model) {
       ...
       ReviewEditForm reviewEditForm = new ReviewEditForm(review.getId(), review.getReviewScore(), review.getReviewText());
